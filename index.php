...
<body>
  ...
  <div class="container">
    <div class="jumbotron">
      ...
      <p><a class="btn btn-primary btn-lg" href="<?php echo DOMAIN ?>/register.php?getstarted">Get started</a></p>
    </div>
    <div class="jumbotron">
	...
	<p>&nbsp;&nbsp;You don't have to own a Google account, but when you access some Google products, you need one, right?</p>
        <p><a class="btn btn-primary btn-lg" href="<?php echo DOMAIN ?>/register.php?tryitnow">Try It Now</a></p>
      </div>
      <div class="jumbotron">
        <h2>FAQs</h2>
      <div>
    ...
    <div>
      <h4><span class="glyphicon glyphicon-question-sign"></span>I am a developer, how to garanteen the auth?</h4>
        <p>&nbsp;&nbsp;It is hard to answer in short, you can have a look at <a href="<?php echo DOMAIN ?>/help.php#qid-6">this</a>.</p>
    </div>
    <div>
      ...
      <a href="<?php echo SITE ?>/help.php" class="btn btn-primary">Learn more</a>
    </div>
  </div>
</div> <!-- /container -->
