				...
				<form id="form-contact" action="javascript:void(0)">
					...
					<div id="form-contact-telephones">
						<div class="input-group form-group"><label for="telephone" class="sr-only">电话号</label>
							...
							<a class="input-group-addon telephone-input-del" href="javascript:void(0)"><span
										class="glyphicon glyphicon-trash"></span></a>
						</div>
						<a class="telephone-add input-group form-group" href="javascript:void(0)"><span
									class="input-group-addon glyphicon glyphicon-plus"></span></a>
					</div>
